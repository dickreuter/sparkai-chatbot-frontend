    ...
    <div className="strategy-form">
      ...
      <div className="sport-type">
        ...
        >
          ...
          <option value="gpt-4-1106-preview">gpt-4-1106-preview-128k (£1.00 / request)</option>
          <option value="gpt-4">gpt-4 8k (£2.00 / request)</option>
          <option value="gpt-4-32k">gpt-4-32k (£4.00 / request)</option>
        </select>
      </div>
