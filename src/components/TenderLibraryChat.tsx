...
const TenderLibraryChat = ({bid_id}) => {
  ...
  const [messages, setMessages] = useState(() => {
    ...
    return [{ type: 'bot', text: 'Ask questions here about your Tender Library documents'}];
  });
  ...
  useEffect(() => {
    ...
    const handleClearMessages = () => {
      setMessages([{ type: 'bot', text: 'Ask questions here about your Tender Library documents' }]);
