...
const NavBar = () => {
    ...
    return (
        <nav className="navbar navbar-expand-sm fixed-top navbar-light bg-light">
            ...
            <a className="navbar-brand" href="/">Spark-Ai Chatbot</a>
            <div className={`collapse navbar-collapse ${isOpen ? 'show' : ''}`} id="navbarTogglerDemo03">
                <ul className="navbar-nav mr-auto d-flex ml-auto">  {/* Apply ml-auto here */}
                    ...
                    }
                    {
                        auth ? (
                            <li className="nav-item">
                                <Link className="nav-link" to="/uploadpdf">Upload PDFs</Link>
                            </li>
                        ) :
                            <>
                            </>
                        ...
                        auth ? (
                            <li className="nav-item">
                                <Link className="nav-link" to="/uploadtext">Upload Text</Link>
                            </li>
                        ) :
                            <>
                            </>
                    }
                    {
                        auth ? email === "adminuser" && (
                            ...
                            <li className="nav-item">
                            <Link className="nav-link" to="/qlog">Question Log </Link>
                            </li>
                            <li className="nav-item">
                            <Link className="nav-link" to="/flog">Feedback Log </Link>
                            </li>
                            </>
