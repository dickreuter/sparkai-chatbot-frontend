    ...
    <div className="sidebar">
      <div className="sidebar-top-title" onClick={toggleActive}>
        ...
        <span className="toggle-icon">
          <FontAwesomeIcon
            icon={isActiveVisible ? faChevronDown : faChevronRight}
          />
        </span>
      </div>
      {isActiveVisible && (
        <div className="sidebar-links">
          ...
          <Link
            state={{ bid: selectedBid, fromBidsTable: true }}
            onClick={(e) => handleFirstLinkClick(e, "#bidinfo")}
            to="/chatbot#bidinfo"
          ...
          <Link
            state={{ bid: selectedBid, fromBidsTable: true }}
            onClick={() => handleSidebarLinkClick("#inputquestion")}
            to="/chatbot#inputquestion"
            className="sidebar-link"
          >
            Question
          </Link>
          <Link
            state={{ bid: selectedBid, fromBidsTable: true }}
            onClick={() => handleSidebarLinkClick("#response")}
            to="/chatbot#response"
            className="sidebar-link"
          >
            Response
          ...
          <Link
            state={{ bid: selectedBid, fromBidsTable: true }}
            onClick={() => handleSidebarLinkClick("#proposal")}
            to="/chatbot#proposal"
            className="sidebar-link"
          >
            Proposal
      ...
      <div className="sidebar-title" onClick={toggleOngoing}>
        ...
        <span className="toggle-icon">
          <FontAwesomeIcon
            icon={isOngoingVisible ? faChevronDown : faChevronRight}
          />
        </span>
      </div>
      {isOngoingVisible && (
      ...
      <div>
        <div className="sidebar-title">
          ...
          <span className="toggle-icon">
            <FontAwesomeIcon
              icon={isCopilotVisible ? faChevronDown : faChevronRight}
            />
          </span>
        </div>
        ...
        {isCopilotVisible && (
          <div className="sidebar-links smaller-links">
            ...
            <a
              href="#"
              onClick={handleLinkClick("Incorporate")}
              className="sidebar-link"
            >
              Incorporate
            </a>
            ...
            <a
              href="#"
              onClick={handleLinkClick("List Creator")}
              className="sidebar-link"
            >
              List Creator
            </a>
            <a
              href="#"
              onClick={handleLinkClick("Reduce Word Character Count")}
              className="sidebar-link"
            >
              Reduce Word Character Count
            </a>
            <a
              href="#"
              onClick={handleLinkClick("Word Cutting Adjectives")}
              className="sidebar-link"
            >
              Word Cutting Adjectives
            </a>
            <a
              href="#"
              onClick={handleLinkClick("Word Cutting Commas with Dashes")}
              className="sidebar-link"
            >
              Word Cutting Commas with Dashes
            </a>
            <a
              href="#"
              onClick={handleLinkClick("Explain How")}
              className="sidebar-link"
            >
              Explain How
            </a>
            ...
            <a
              href="#"
              onClick={handleLinkClick("Adding Case Study")}
              className="sidebar-link"
            >
              Adding Case Study
            </a>
