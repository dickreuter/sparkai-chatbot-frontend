...
const QuickQuestionWizard = () => {
  ...
  const steps = [
    ...
    },
    {
        elementId: 'clear',
        title: 'Clear Chat',
        description: 'Need a fresh start?  To clear your chat, click this trash can button 🗑️ ',
      }
  ];

  useEffect(() => {
    const checkTourStatus = () => {
      const tourCompleted = localStorage.getItem('quickquestionWizardTourCompleted');
