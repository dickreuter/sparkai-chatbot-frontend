...
describe('BidExtractor Component', () => {
  ...
  it('should handle file upload and extract questions', async () => {
    ...
    mock.onPost(`/http://localhost:8000/extract_questions_from_pdf`).reply(200, extractedQuestions);
    ...
    expect(contextValue.setSharedState).toHaveBeenCalledWith(expect.objectContaining({
